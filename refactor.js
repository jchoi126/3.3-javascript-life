...
// The function is now an anonymous function as well as an expression.
...
// Put your answer below -------------------------
// C because there is a setTimeout that delays the string y
// [c]: z then y
// -----------------------------------------------
...
var spanishColor = function(colorSpanish) {
  var colorName = {
    // colors are the KEYS
    // Hexs are the values
    rojo: '#ff0000',
  ...
  return colorName[colorSpanish.toLowerCase()];
};
...
var callNTimes = function(callback,loop) {
...
// Put your answer below -------------------------
// I am getting a NaN because speed is a number and when += with amount, the
// function is not returning a number
...
// IFFY - Immediately Invoked Function Espression
(function(){
  "use strict";
  var score = 0
